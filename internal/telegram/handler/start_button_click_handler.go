...
const (
	greetingBotMessage = "Здравствуйте, *%s %s*!\n\nЭто телеграм бот - *Yulia-lingo*.\n\n" +
		...
		"*Сейчас доступна возможность:*" +
		"\n- Просмотреть список неправильных глаголов для изучения." +
		"\n- Получить перевод слова с Английского на Русский язык." +
		"\n- Сохранить слово и его перевод в свой список слов для изучения." +
		"\n- Просмотреть свой список слов для изучения."
)
